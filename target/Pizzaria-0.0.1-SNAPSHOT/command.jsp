						...
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 contact-left">
							...
							<div class="panel panel-default">
								<div class="panel-body">
									<div class="store-image"><img src="assets/images/logo-pizza.png" alt="Your Store"
											title="Your Store" class="img-responsive"></div>
									<div class="store-address">
										<i class="fa fa-home"></i>
										<div class="store-title">Your Store</div>
										<div class="store-detail">Cité hay el ons, route tunis km 10</div>
						...
						<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 contact-right">
							<form action="#" method="post" enctype="multipart/form-data"
								...
								<fieldset>
									...
									<div class="form-group required row">
										<label class="col-sm-2 control-label" for="input-enquiry">Additional information</label>
										<div class="col-sm-10">
