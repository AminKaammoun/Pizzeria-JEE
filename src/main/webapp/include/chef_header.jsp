										...
										<div class="container">
											<ul class="themability_megamenu" data-megamenuid="55"
												...
												<li class="home current-active active-first"><a
													href="order_list.jsp"> <span><strong>
																Pending Orders </strong></span>
												</a></li>
 
												<li class="with-sub-menu click"><a href="current_order.jsp"
													class="clearfix"> <strong> Current Orders</strong>

												</a></li>

												<li class="with-sub-menu click"><a href="ready_order.jsp"
													class="clearfix"> <strong>Ready Orders</strong>
